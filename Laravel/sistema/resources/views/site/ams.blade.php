...
<body class="d-flex flex-column min-vh-100" style="background-color:rgba(216, 216, 216, 0.2);">
  ...
  <div class="row">
    <div class="col">
    <h4 class="fw-4" style="color:rgba(156, 10, 10, 0.59);">Articulação dos Ensinos Médio - Técnico e Superior (AMS)</h4>
    <h6 class="fw-4 fw-light" >1 curso encontrado</h6>
    </div>
  </div>
</div>
<br>
...
<div class="container text-start pt-2 pb-5">
  ...
  <img src="{{ asset('img/ams.jpg') }}" class="card-img-top" alt="...">
  <div class="card-body">
