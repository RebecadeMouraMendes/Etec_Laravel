...
<body class="d-flex flex-column min-vh-100" style="background-color:rgba(216, 216, 216, 0.2);">
  ...
  <div class="row">
    <div class="col">
    <h4 class="fw-4" style="color:rgba(156, 10, 10, 0.59);">Cursos Técnicos - Modalidade Presencial</h4>
    <h6 class="fw-4 fw-light" >7 cursos encontrados</h6>
    </div>
  </div>
</div>
...
<br><br>
<div class="card" style="width: 18rem;">
  <img src="{{ asset('img/contabilidade.jpg') }}" class="card-img-top" alt="...">
  <div class="card-body">
...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    ...
    <div class="col">
    <div class="card" style="width: 18rem;">
  <img src="{{ asset('img/financas.jpg') }}" class="card-img-top" alt="...">
  <div class="card-body">
...
<br><br>
<div class="card" style="width: 18rem;">
  <img src="{{ asset('img/juridico.jpg') }}" class="card-img-top" alt="...">
  <div class="card-body">
